...
public final class Catalog {
    ...
    /** Compute steel weight kg/m for a pipe given OD and wall (mm) using ρ=7850 kg/m³. */
    private static Pipe mkPipe(String dn, String nps, double od, String sch, double wall) {
        double w = Math.PI * wall * (od - wall) * 7.85 / 1000.0;
        return new Pipe(dn, nps, od, sch, wall, Math.round(w * 100.0) / 100.0);
    }

    /** ASME B36.10 — NPS 1/8" → 24" with common schedules. Weight = steel ρ=7850. */
    public static final List<Pipe> PIPES = List.of(
        // NPS 1/8" — DN6 — OD 10.3
        mkPipe("DN6",  "1/8\"",     10.3, "Sch 5",   1.24),
        mkPipe("DN6",  "1/8\"",     10.3, "Sch 10",  1.24),
        mkPipe("DN6",  "1/8\"",     10.3, "Sch 40",  1.73),
        mkPipe("DN6",  "1/8\"",     10.3, "Sch 80",  2.41),
        // NPS 1/4" — DN8 — OD 13.7
        mkPipe("DN8",  "1/4\"",     13.7, "Sch 5",   1.65),
        mkPipe("DN8",  "1/4\"",     13.7, "Sch 10",  1.65),
        mkPipe("DN8",  "1/4\"",     13.7, "Sch 40",  2.24),
        mkPipe("DN8",  "1/4\"",     13.7, "Sch 80",  3.02),
        // NPS 3/8" — DN10 — OD 17.1
        mkPipe("DN10", "3/8\"",     17.1, "Sch 5",   1.65),
        mkPipe("DN10", "3/8\"",     17.1, "Sch 10",  1.65),
        mkPipe("DN10", "3/8\"",     17.1, "Sch 40",  2.31),
        mkPipe("DN10", "3/8\"",     17.1, "Sch 80",  3.20),
        // NPS 1/2" — DN15 — OD 21.3
        mkPipe("DN15", "1/2\"",     21.3, "Sch 5",   1.65),
        mkPipe("DN15", "1/2\"",     21.3, "Sch 10",  2.11),
        mkPipe("DN15", "1/2\"",     21.3, "Sch 40",  2.77),
        mkPipe("DN15", "1/2\"",     21.3, "Sch 80",  3.73),
        mkPipe("DN15", "1/2\"",     21.3, "Sch 160", 4.78),
        mkPipe("DN15", "1/2\"",     21.3, "XXS",     7.47),
        // NPS 3/4" — DN20 — OD 26.7
        mkPipe("DN20", "3/4\"",     26.7, "Sch 5",   1.65),
        mkPipe("DN20", "3/4\"",     26.7, "Sch 10",  2.11),
        mkPipe("DN20", "3/4\"",     26.7, "Sch 40",  2.87),
        mkPipe("DN20", "3/4\"",     26.7, "Sch 80",  3.91),
        mkPipe("DN20", "3/4\"",     26.7, "Sch 160", 5.56),
        mkPipe("DN20", "3/4\"",     26.7, "XXS",     7.82),
        // NPS 1" — DN25 — OD 33.4
        mkPipe("DN25", "1\"",       33.4, "Sch 5",   1.65),
        mkPipe("DN25", "1\"",       33.4, "Sch 10",  2.77),
        mkPipe("DN25", "1\"",       33.4, "Sch 40",  3.38),
        mkPipe("DN25", "1\"",       33.4, "Sch 80",  4.55),
        mkPipe("DN25", "1\"",       33.4, "Sch 160", 6.35),
        mkPipe("DN25", "1\"",       33.4, "XXS",     9.09),
        // NPS 1-1/4" — DN32 — OD 42.2
        mkPipe("DN32", "1-1/4\"",   42.2, "Sch 5",   1.65),
        mkPipe("DN32", "1-1/4\"",   42.2, "Sch 10",  2.77),
        mkPipe("DN32", "1-1/4\"",   42.2, "Sch 40",  3.56),
        mkPipe("DN32", "1-1/4\"",   42.2, "Sch 80",  4.85),
        mkPipe("DN32", "1-1/4\"",   42.2, "Sch 160", 6.35),
        mkPipe("DN32", "1-1/4\"",   42.2, "XXS",     9.70),
        // NPS 1-1/2" — DN40 — OD 48.3
        mkPipe("DN40", "1-1/2\"",   48.3, "Sch 5",   1.65),
        mkPipe("DN40", "1-1/2\"",   48.3, "Sch 10",  2.77),
        mkPipe("DN40", "1-1/2\"",   48.3, "Sch 40",  3.68),
        mkPipe("DN40", "1-1/2\"",   48.3, "Sch 80",  5.08),
        mkPipe("DN40", "1-1/2\"",   48.3, "Sch 160", 7.14),
        mkPipe("DN40", "1-1/2\"",   48.3, "XXS",    10.16),
        // NPS 2" — DN50 — OD 60.3
        mkPipe("DN50", "2\"",       60.3, "Sch 5",   1.65),
        mkPipe("DN50", "2\"",       60.3, "Sch 10",  2.77),
        mkPipe("DN50", "2\"",       60.3, "Sch 40",  3.91),
        mkPipe("DN50", "2\"",       60.3, "Sch 80",  5.54),
        mkPipe("DN50", "2\"",       60.3, "Sch 160", 8.74),
        mkPipe("DN50", "2\"",       60.3, "XXS",    11.07),
        // NPS 2-1/2" — DN65 — OD 73.0
        mkPipe("DN65", "2-1/2\"",   73.0, "Sch 5",   2.11),
        mkPipe("DN65", "2-1/2\"",   73.0, "Sch 10",  3.05),
        mkPipe("DN65", "2-1/2\"",   73.0, "Sch 40",  5.16),
        mkPipe("DN65", "2-1/2\"",   73.0, "Sch 80",  7.01),
        mkPipe("DN65", "2-1/2\"",   73.0, "Sch 160", 9.53),
        mkPipe("DN65", "2-1/2\"",   73.0, "XXS",    14.02),
        // NPS 3" — DN80 — OD 88.9
        mkPipe("DN80", "3\"",       88.9, "Sch 5",   2.11),
        mkPipe("DN80", "3\"",       88.9, "Sch 10",  3.05),
        mkPipe("DN80", "3\"",       88.9, "Sch 40",  5.49),
        mkPipe("DN80", "3\"",       88.9, "Sch 80",  7.62),
        mkPipe("DN80", "3\"",       88.9, "Sch 160",11.13),
        mkPipe("DN80", "3\"",       88.9, "XXS",    15.24),
        // NPS 3-1/2" — DN90 — OD 101.6
        mkPipe("DN90", "3-1/2\"",  101.6, "Sch 5",   2.11),
        mkPipe("DN90", "3-1/2\"",  101.6, "Sch 10",  3.05),
        mkPipe("DN90", "3-1/2\"",  101.6, "Sch 40",  5.74),
        mkPipe("DN90", "3-1/2\"",  101.6, "Sch 80",  8.08),
        // NPS 4" — DN100 — OD 114.3
        mkPipe("DN100","4\"",      114.3, "Sch 5",   2.11),
        mkPipe("DN100","4\"",      114.3, "Sch 10",  3.05),
        mkPipe("DN100","4\"",      114.3, "Sch 40",  6.02),
        mkPipe("DN100","4\"",      114.3, "Sch 80",  8.56),
        mkPipe("DN100","4\"",      114.3, "Sch 120",11.13),
        mkPipe("DN100","4\"",      114.3, "Sch 160",13.49),
        mkPipe("DN100","4\"",      114.3, "XXS",    17.12),
        // NPS 5" — DN125 — OD 141.3
        mkPipe("DN125","5\"",      141.3, "Sch 5",   2.77),
        mkPipe("DN125","5\"",      141.3, "Sch 10",  3.40),
        mkPipe("DN125","5\"",      141.3, "Sch 40",  6.55),
        mkPipe("DN125","5\"",      141.3, "Sch 80",  9.53),
        mkPipe("DN125","5\"",      141.3, "Sch 120",12.70),
        mkPipe("DN125","5\"",      141.3, "Sch 160",15.88),
        mkPipe("DN125","5\"",      141.3, "XXS",    19.05),
        // NPS 6" — DN150 — OD 168.3
        mkPipe("DN150","6\"",      168.3, "Sch 5",   2.77),
        mkPipe("DN150","6\"",      168.3, "Sch 10",  3.40),
        mkPipe("DN150","6\"",      168.3, "Sch 40",  7.11),
        mkPipe("DN150","6\"",      168.3, "Sch 80", 10.97),
        mkPipe("DN150","6\"",      168.3, "Sch 120",14.27),
        mkPipe("DN150","6\"",      168.3, "Sch 160",18.26),
        mkPipe("DN150","6\"",      168.3, "XXS",    21.95),
        // NPS 8" — DN200 — OD 219.1
        mkPipe("DN200","8\"",      219.1, "Sch 5",   2.77),
        mkPipe("DN200","8\"",      219.1, "Sch 10",  3.76),
        mkPipe("DN200","8\"",      219.1, "Sch 20",  6.35),
        mkPipe("DN200","8\"",      219.1, "Sch 30",  7.04),
        mkPipe("DN200","8\"",      219.1, "Sch 40",  8.18),
        mkPipe("DN200","8\"",      219.1, "Sch 60", 10.31),
        mkPipe("DN200","8\"",      219.1, "Sch 80", 12.70),
        mkPipe("DN200","8\"",      219.1, "Sch 100",15.09),
        mkPipe("DN200","8\"",      219.1, "Sch 120",18.26),
        mkPipe("DN200","8\"",      219.1, "Sch 140",20.62),
        mkPipe("DN200","8\"",      219.1, "Sch 160",23.01),
        mkPipe("DN200","8\"",      219.1, "XXS",    22.23),
        // NPS 10" — DN250 — OD 273.0
        mkPipe("DN250","10\"",     273.0, "Sch 5",   3.40),
        mkPipe("DN250","10\"",     273.0, "Sch 10",  4.19),
        mkPipe("DN250","10\"",     273.0, "Sch 20",  6.35),
        mkPipe("DN250","10\"",     273.0, "Sch 30",  7.80),
        mkPipe("DN250","10\"",     273.0, "Sch 40",  9.27),
        mkPipe("DN250","10\"",     273.0, "Sch 60", 12.70),
        mkPipe("DN250","10\"",     273.0, "Sch 80", 15.09),
        mkPipe("DN250","10\"",     273.0, "Sch 100",18.26),
        mkPipe("DN250","10\"",     273.0, "Sch 120",21.44),
        mkPipe("DN250","10\"",     273.0, "Sch 140",25.40),
        mkPipe("DN250","10\"",     273.0, "Sch 160",28.58),
        // NPS 12" — DN300 — OD 323.9
        mkPipe("DN300","12\"",     323.9, "Sch 5",   3.96),
        mkPipe("DN300","12\"",     323.9, "Sch 10",  4.57),
        mkPipe("DN300","12\"",     323.9, "Sch 20",  6.35),
        mkPipe("DN300","12\"",     323.9, "Sch 30",  8.38),
        mkPipe("DN300","12\"",     323.9, "Sch 40", 10.31),
        mkPipe("DN300","12\"",     323.9, "Sch 60", 14.27),
        mkPipe("DN300","12\"",     323.9, "Sch 80", 17.48),
        mkPipe("DN300","12\"",     323.9, "Sch 100",21.44),
        mkPipe("DN300","12\"",     323.9, "Sch 120",25.40),
        mkPipe("DN300","12\"",     323.9, "Sch 140",28.58),
        mkPipe("DN300","12\"",     323.9, "Sch 160",33.32),
        // NPS 14" — DN350 — OD 355.6
        mkPipe("DN350","14\"",     355.6, "Sch 10",  6.35),
        mkPipe("DN350","14\"",     355.6, "Sch 20",  7.92),
        mkPipe("DN350","14\"",     355.6, "Sch 30",  9.53),
        mkPipe("DN350","14\"",     355.6, "Sch 40", 11.13),
        mkPipe("DN350","14\"",     355.6, "Sch 60", 15.09),
        mkPipe("DN350","14\"",     355.6, "Sch 80", 19.05),
        mkPipe("DN350","14\"",     355.6, "Sch 100",23.83),
        mkPipe("DN350","14\"",     355.6, "Sch 120",27.79),
        mkPipe("DN350","14\"",     355.6, "Sch 140",31.75),
        mkPipe("DN350","14\"",     355.6, "Sch 160",35.71),
        // NPS 16" — DN400 — OD 406.4
        mkPipe("DN400","16\"",     406.4, "Sch 10",  6.35),
        mkPipe("DN400","16\"",     406.4, "Sch 20",  7.92),
        mkPipe("DN400","16\"",     406.4, "Sch 30",  9.53),
        mkPipe("DN400","16\"",     406.4, "Sch 40", 12.70),
        mkPipe("DN400","16\"",     406.4, "Sch 60", 16.66),
        mkPipe("DN400","16\"",     406.4, "Sch 80", 21.44),
        mkPipe("DN400","16\"",     406.4, "Sch 100",26.19),
        mkPipe("DN400","16\"",     406.4, "Sch 120",30.96),
        mkPipe("DN400","16\"",     406.4, "Sch 140",36.53),
        mkPipe("DN400","16\"",     406.4, "Sch 160",40.49),
        // NPS 18" — DN450 — OD 457.0
        mkPipe("DN450","18\"",     457.0, "Sch 10",  6.35),
        mkPipe("DN450","18\"",     457.0, "Sch 20",  7.92),
        mkPipe("DN450","18\"",     457.0, "Sch 30", 11.13),
        mkPipe("DN450","18\"",     457.0, "Sch 40", 14.27),
        mkPipe("DN450","18\"",     457.0, "Sch 60", 19.05),
        mkPipe("DN450","18\"",     457.0, "Sch 80", 23.83),
        mkPipe("DN450","18\"",     457.0, "Sch 100",29.36),
        mkPipe("DN450","18\"",     457.0, "Sch 120",34.93),
        mkPipe("DN450","18\"",     457.0, "Sch 140",39.67),
        mkPipe("DN450","18\"",     457.0, "Sch 160",45.24),
        // NPS 20" — DN500 — OD 508.0
        mkPipe("DN500","20\"",     508.0, "Sch 10",  6.35),
        mkPipe("DN500","20\"",     508.0, "Sch 20",  9.53),
        mkPipe("DN500","20\"",     508.0, "Sch 30", 12.70),
        mkPipe("DN500","20\"",     508.0, "Sch 40", 15.09),
        mkPipe("DN500","20\"",     508.0, "Sch 60", 20.62),
        mkPipe("DN500","20\"",     508.0, "Sch 80", 26.19),
        mkPipe("DN500","20\"",     508.0, "Sch 100",32.54),
        mkPipe("DN500","20\"",     508.0, "Sch 120",38.10),
        mkPipe("DN500","20\"",     508.0, "Sch 140",44.45),
        mkPipe("DN500","20\"",     508.0, "Sch 160",50.01),
        // NPS 24" — DN600 — OD 610.0
        mkPipe("DN600","24\"",     610.0, "Sch 10",  6.35),
        mkPipe("DN600","24\"",     610.0, "Sch 20",  9.53),
        mkPipe("DN600","24\"",     610.0, "Sch 30", 14.27),
        mkPipe("DN600","24\"",     610.0, "Sch 40", 17.48),
        mkPipe("DN600","24\"",     610.0, "Sch 60", 24.61),
        mkPipe("DN600","24\"",     610.0, "Sch 80", 30.96),
        mkPipe("DN600","24\"",     610.0, "Sch 100",38.89),
        mkPipe("DN600","24\"",     610.0, "Sch 120",46.02),
        mkPipe("DN600","24\"",     610.0, "Sch 140",52.37),
        mkPipe("DN600","24\"",     610.0, "Sch 160",59.54)
    );
